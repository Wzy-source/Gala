...
contract IDXM is Owned, SafeMath {
    uint8 public decimals = 8; // chs
    bytes32 public standard = 'Token 0.1'; // chs
    bytes32 public name = 'IDEX Membership'; // chs
    bytes32 public symbol = 'IDXM'; // csh
    ...
    uint256 public baseFeeDivisor; // csh
    ...
    uint8 public feeDecimals = 8; // ❌ chs
    ...
    uint256 public mustHoldFor = 604800; // ✅ chs
    ...
    function IDXM() {
        ...
        balanceOf[msg.sender] = totalSupply; // chs
        exportFee[0x00000000000000000000000000000000000000ff] = 100000000; // chs
        precalculate();
    }

    bool public balancesLocked = false; // ✅ chs
    ...
    function lockBalances() onlyOwner { // ✅ 没有考虑modifier
        balancesLocked = true;
    }
   ...
   */
    function transfer(address _to, uint256 _amount) returns (bool success) {
        ...
        balanceOf[msg.sender] -= _amount; // ❌ 对于-= / += 使用的都是Binary 而不是 Assignment
...
function unlockToken(bool lock_state) public {
locked = lock_state; // ✅
}



function do_unlock(bool lock_state) public onlyOwner {
unlockToken(lock_state);
}
...
singleIDXMQty = pow10(1, decimals); // chs
}
